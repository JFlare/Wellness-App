...
public class MariaCrossword extends AppCompatActivity
{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_maria_crossword);
    ...
    private void init() {
        mGridView = (GestureDetectGridView) findViewById(R.id.Mariagrid);
    ...
    private static void swap(Context context, int currentPosition, int swap) {
        ...
        if (isSolved()) {
            Toast.makeText(context, "\tYOU WIN! " + "\nMaria does not want to go to the hospital!", Toast.LENGTH_LONG).show();
            playDing();
        }
    }
